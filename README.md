...
SQL → модель → DAX/Python → визуализация → вывод.

![Power BI](https://img.shields.io/badge/Power_BI-F2C811?style=flat&logo=powerbi&logoColor=black)
![DAX](https://img.shields.io/badge/DAX-01B8AA?style=flat)
![Power Query](https://img.shields.io/badge/Power_Query_(M)-3776AB?style=flat)
...
Здесь — **пет-проекты на реальных открытых данных**, где виден весь путь работы:
от очистки до бизнес-вывода. По каждому проекту есть кейс-README, код (DAX/SQL),
скриншоты и живая ссылка на отчёт.
...
| **Аналитика** | RFM-сегментация, когортный анализ, retention, воронки, юнит-экономика |
| **Python** | pandas / numpy — обработка и разведочный анализ данных |
...
- 💼 LinkedIn: _<ссылка>_
- ✈️ Telegram: _<@username>_

---

> Каждый проект оформлен как кейс: **задача → данные → что чистила → модель →
> DAX/SQL → инсайты**. Открывай папку проекта — там всё по порядку.
